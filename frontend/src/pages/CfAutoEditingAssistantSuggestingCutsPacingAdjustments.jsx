...
export default function CfAutoEditingAssistantSuggestingCutsPacingAdjustments() {
  ...
  const submit = async (e) => {
    ...
    try {
      const res = await fetch(`${API_BASE}/api/cf-auto-editing-assistant-suggesting-cuts-pacing-adjustments-retakes/run`, {
        method: 'POST', headers: getHeaders(),
        body: JSON.stringify({ prompt: input, feature: 'cf-auto-editing-assistant-suggesting-cuts-pacing-adjustments-retakes', project: 'AIVideoTestimonialCreator' })
      })
  ...
  const loadHistory = async () => {
    try {
      const res = await fetch(`${API_BASE}/api/cf-auto-editing-assistant-suggesting-cuts-pacing-adjustments-retakes/history`, { headers: getHeaders() })
      const data = await res.json()
  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      <div className="mb-4">
        <h1 className="text-2xl font-bold text-slate-800">Auto-editing assistant suggesting cuts, pacing adjustments, retakes</h1>
