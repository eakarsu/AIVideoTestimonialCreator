...
// Feature: Emotional tone and body-language analysis for authenticity scoring
...
export default function CfEmotionalToneAndBodyLanguageAnalysisFor() {
  ...
  const submit = async (e) => {
    ...
    try {
      const res = await fetch(`${API_BASE}/api/cf-emotional-tone-and-body-language-analysis-for-authenticity-scoring/run`, {
        method: 'POST', headers: getHeaders(),
        body: JSON.stringify({ prompt: input, feature: 'cf-emotional-tone-and-body-language-analysis-for-authenticity-scoring', project: 'AIVideoTestimonialCreator' })
      })
  ...
  const loadHistory = async () => {
    try {
      const res = await fetch(`${API_BASE}/api/cf-emotional-tone-and-body-language-analysis-for-authenticity-scoring/history`, { headers: getHeaders() })
      const data = await res.json()
  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      <div className="mb-4">
        <h1 className="text-2xl font-bold text-slate-800">Emotional tone and body-language analysis for authenticity scoring</h1>
